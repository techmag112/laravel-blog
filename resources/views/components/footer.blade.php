                ...
                <div class="footer-social order-1 lg:order-2 basis-full sm:basis-1/2 lg:basis-1/3 mt-8 sm:mt-0" style="margin-right:50px;">
                    <div class="flex flex-wrap items-center justify-center sm:justify-end space-x-6">
                        <a class="inline-flex items-center text-white hover:text-pink"
                           ...
                           target="_blank">
                            <img alt="YouTube" class="h-5 lg:h-6" src="{{ Vite::asset('resources/assets/images/icons/youtube.svg')}}">
                        ...
                        <a href="#" class="inline-flex items-center text-white hover:text-pink"
                           rel="nofollow noopener" target="_blank">
                            <img alt="Telegram" class="h-5 lg:h-6" src="{{ Vite::asset('resources/assets/images/icons/telegram.svg')}}">
