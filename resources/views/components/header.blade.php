    <header class="header pt-6 xl:pt-12">
        <div style="margin-left:50px;">
            <div class="header-inner flex items-center justify-between lg:justify-start">
                ...
                <div class="header-actions flex items-center gap-3 md:gap-5 z-[9999]  style="margin-right: 50px;">
                        <div>
                            ...
                            @auth
                                <form action="{{route('logout')}}" method="POST" class="profile xs:flex items-center">
                                    ...
                                    @method("DELETE")
                                    <button type="submit">
                                        <span class="profile-text relative ml-2 text-white text-xxs md:text-xs font-bold" style="margin-right: 50px;">Logout</span>
                                    </button>
                                </form>
                            @elseguest
                                <a href="{{route('login')}}" class="profile xs:flex items-center">
                                    <span class="profile-text relative ml-2 text-white text-xxs md:text-xs font-bold" style="margin-right: 50px;">Login</span>
                                </a>
                            @endguest
                </div><!-- /.header-actions -->
            </div><!-- /.header-inner -->
